...
ACTUAL = "/home/xilinx/jupyter_notebooks/Overlays/Week13/input3.txt"
ACK = 'ACK'

file = open(ACTUAL, "w").close()
file03 = open("/home/xilinx/jupyter_notebooks/CommsExternal/write_offset03.txt", "w").close()
    ...
    try:
        ...
        while True:
            ...
            if ( ( data.decode().rstrip() ).__contains__( 'Start movement' ) ):
                ...
                with open("/home/xilinx/jupyter_notebooks/CommsExternal/write_offset03.txt", "a") as f:
