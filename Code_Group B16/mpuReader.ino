...
{      
  ...
  if(error) Serial.println("MPU6050_WHO_AM_I error");

  error = MPU6050_read (MPU6050_PWR_MGMT_2, &c, 1);
  
  if(error) Serial.println("MPU6050_PWR_MGMT_2 error");
...
void loop()
{
  ...
  if(hasStarted == true & Serial.available()) {
...
// a common function to read multiple bytes 
...
// a common function to write multiple bytes to an I2C device
