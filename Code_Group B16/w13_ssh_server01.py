...
ACTUAL = "/home/xilinx/jupyter_notebooks/Overlays/Week13/input1.txt"
ACK = 'ACK'

file = open(ACTUAL, "w").close()
file01 = open("/home/xilinx/jupyter_notebooks/CommsExternal/write_offset01.txt", "w").close()
...
def parse_ACK(data):
    global tc3
    decoded_data = data.decode()
    message01 = decoded_data.split('\n')
    messages = message01[0].split('/')
    message, time0, time3 = messages[:3]
    tc3 = time0
    ...
    try:
        ...
        while True:
            ...
            if ( ( data.decode().rstrip() ).__contains__( 'Start movement' ) ):
                ...
                with open("/home/xilinx/jupyter_notebooks/CommsExternal/write_offset01.txt", "a") as f:
